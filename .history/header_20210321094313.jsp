...
<%
    ...
    String hrefUpdate = "update.jsp";
    String linkUpdate = "Update";

    //String dynamicDashboardLink = ((Student) session.getAttribute("aStudent") != null)?"<a href=\"./dashboard.jsp\">Dashboard</a></td>":"";
%>
...
<%
   ...
   //For the message flashing
    ...
    if (error == null)
    {
      error = ""; //prevents null pointer exceptions
    }
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark text-light fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.jsp">WEBD4201</a>
    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <!-- BEGINNING OF THE IF STMT TO DETERMINE NAVBAR LINKS -->
        <% if (((Student) session.getAttribute("aStudent") == null)) { %>
          <li class="nav-item">
            <a class="nav-link"  href="<%= hrefLogin %>"><%= linkLogin %></a>
          </li>
          <li class="nav-item">
            <a class="nav-link"  href="<%= hrefRegister %>"><%= linkRegister %></a>
          </li>
        <% } else { %> <!-- IF USER IS LOGGED IN -->
          <li class="nav-item">
            <a class="nav-link"  href="<%= hrefIndex %>"><%= linkIndex %></a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link"  href="<%= hrefUpdate %>"><%= linkUpdate %></a>
          </li>

          <form class="nav-item" action="./Logout">
          <li class="nav-item"  >
        ...
        <!--
        <li class="nav-item">
          <a class="nav-link" href="<%= hrefDashboard %>"><%= linkDashboard %></a>
        </li>
