...
<div>
		...
		<p>
		   ...
		   <a class="text-dark" href="index.jsp">Bradshaw Marina</a> home page.
	    </p>

		<p>If you want to become a customer on our system, please <a class="text-dark" href="register.jsp">register</a>.</p>
</div>
