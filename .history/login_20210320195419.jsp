...
<div>
	...
	<form class="form-signin" method="POST" action="/Login">
    	...
    	<input type="email" id="Login" name="Login" class="form-control" name="email" value="" placeholder="Email address" required autofocus>

    	<label for="inputPassword" class="sr-only">Password</label>
    	<input type="password" id="Password" name="Password" class="form-control" name="passwd" value="" placeholder="Password" required>
