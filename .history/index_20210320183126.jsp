...
<div class="center">
	...
	<h5>
		...
		<br/><br/>
		Once logged in you will notice that neither of those buttons exist anymore, instead the navbar is populated with a button to the home (this) page, a dashboard button (only available once logged in), 
